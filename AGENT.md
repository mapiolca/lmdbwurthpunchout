# AGENT.md - LmdbWurthPunchout

This repository is the root of the Dolibarr external module `lmdbwurthpunchout`.

Implementation rules:

- Do not modify Dolibarr core files.
- Keep the module installable under `htdocs/custom/lmdbwurthpunchout`.
- Keep `config_page_url` limited to `setup.php@lmdbwurthpunchout`.
...
- Update `README.md`, `ChangeLog.md`, `langs/fr_FR/lmdbwurthpunchout.lang` and `langs/en_US/lmdbwurthpunchout.lang` for user-visible changes.
